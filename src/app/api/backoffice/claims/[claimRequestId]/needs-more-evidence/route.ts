...
import { requestMoreEvidenceClaim } from "@/features/backoffice/claims/service";
...
export async function POST(request: NextRequest, context: RouteContext) {
  try {
    ...
    return toBackofficeErrorResponse(error, "No se pudo completar la operación de backoffice (claims claimRequestId needs-more-evidence).");
  }
}
