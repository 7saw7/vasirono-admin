...
export const backofficeNav: BackofficeNavItem[] = [
  ...
  { label: "Taxonomías", href: BACKOFFICE_ROUTES.taxonomies, permission: "taxonomies.read", icon: "layers", group: "Inteligencia" },
  { label: "Planes", href: BACKOFFICE_ROUTES.plans, permission: "plans.read", icon: "plans", group: "Monetización" },
  ...
  { label: "Promociones", href: BACKOFFICE_ROUTES.promotions, permission: "promotions.read", icon: "promotions", group: "Monetización" },
  { label: "Notificaciones", href: BACKOFFICE_ROUTES.notifications, permission: "notifications.read", icon: "notifications", group: "Sistema" },
  { label: "Configuración", href: BACKOFFICE_ROUTES.settings, permission: "settings.read", icon: "settings", group: "Sistema" },
];
